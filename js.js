...
function replaceEmojis(){
    ...
    chatStr = chatStr.replace(";)",  "<img class='emoji' src='img/wink.gif' />");
    chatStr = chatStr.replace(":/",  "<img class='emoji' src='img/hmm.gif' />");
    chatStr = chatStr.replace("(poop)",  "<img class='emoji' src='img/poop.gif' />");
    chatStr = chatStr.replace(":o", "<img class='emoji' src='img/wow.png' />");
}
